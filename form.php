<?php 
...

    {
      ...
      $result = mysqli_query($mysqli, "INSERT INTO solicitacoes(nome,email,telefone,cidade,sexo,data_nascimento,qnt_oleo,consultatype) VALUES ('$nome','$email','$telefone','$cidade','$sexo','$data_nascimento','$qnt_oleo','$consultatype')");
